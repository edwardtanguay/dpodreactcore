...
function Site() {
	...
	return (
		<div className='app_site'>
			...
			<div className="versionInfo">Datapod for React CORE - <a href="https://github.com/edwardtanguay/dpodreactcore#versions-datapod-for-react-core">Version 0.02.00</a></div>
		</div>
	);
}
