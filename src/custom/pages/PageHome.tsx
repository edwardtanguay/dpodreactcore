...
function PageHome() {
	...
	return (
		<div className="page page_home">
			<p>This site is where I publish all the content I create, from code examples, how-to instructions, to excerpts from books I am reading, notes from courses I take, etc.</p>
